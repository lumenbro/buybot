...
If you want files directly in C:\Users\YourUsername\BUY BOT, move the contents of C:\Users\YourUsername\BUY BOT\buybot to C:\Users\YourUsername\BUY BOT.
In File Explorer, open C:\Users\YourUsername\BUY BOT\buybot, select all files (Ctrl+A), cut (Ctrl+X), go to C:\Users\YourUsername\BUY BOT, and paste (Ctrl+V).
...
NOTE: SEE .env.example FOR CORRECT .env FORMAT TO POPULATE YOUR OWN VARIABLES (readme.md may not display the format correctly)
...
INFO:__main__:Bot stopped by user.
